...
function draw(){
    ...
    // Render Poem.
    image(poem, tSize*1.7, tSize *2.5, width-width/1.6,height-tSize*3);
...
function renderTitle(){
    ...
    //textStyle(NORMAL);
    strokeWeight(8);
    text("Year 7 Winner!", tSize*1.7,tSize);
...
//            255-Math.sin(frameCount/40)*255);
    ...
    strokeWeight(1);
    textStyle(ITALIC);
    text("Michela Castello-Lamb", tSize*1.7,tSize*2);
    textSize(tSize/3);
